...
class MovimentoForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $id = new TEntry('id');
        $tipo_movimento_id = new TDBCombo('tipo_movimento_id', 'ancora907_erpsimples', 'TipoMovimento', 'id', '{descricao}','descricao asc' , $criteria_tipo_movimento_id );
        $situacao_id = new TDBCombo('situacao_id', 'ancora907_erpsimples', 'Situacao', 'id', '{descricao}','descricao asc'  );
        $tipo_estoque = new THidden('tipo_estoque');
        $situacao_id_ant = new THidden('situacao_id_ant');
        $pessoa_id = new TDBUniqueSearch('pessoa_id', 'ancora907_erpsimples', 'Pessoa', 'id', 'nome','nome asc'  );
        $data_abertura = new TDate('data_abertura');
        $data_entrega = new TDate('data_entrega');
        $tipo_documento_id = new TDBCombo('tipo_documento_id', 'ancora907_erpsimples', 'TipoDocumento', 'id', '{descricao}','descricao asc'  );
        ...
        $produtos_movimento_movimento_produto_id = new TDBUniqueSearch('produtos_movimento_movimento_produto_id', 'ancora907_erpsimples', 'Produto', 'id', 'descricao','descricao asc'  );
    ...
    public function onReloadProdutosMovimentoMovimento( $param )
    {
        ...
        { 
            ...
            foreach ($items as $key => $item) 
            {
                ...
                {
                    TTransaction::open('ancora907_erpsimples');
