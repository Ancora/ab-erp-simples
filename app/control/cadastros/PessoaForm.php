...
class PessoaForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $grupo = new TDBCheckGroup('grupo', 'ancora907_erpsimples', 'Grupo', 'id', '{descricao}','descricao asc' , $criteria_grupo );
        ...
        $uf = new TDBCombo('uf', 'ancora907_erpsimples', 'Cidade', 'uf_id', '{uf->sigla}','descricao asc'  );
        $cidade_id = new TDBCombo('cidade_id', 'ancora907_erpsimples', 'Cidade', 'id', '{descricao}','descricao asc' , $criteria_cidade_id );
        ...
        $row7 = $this->form->addFields([new TLabel("Bairro", null, '14px', null, '100%'),$bairro],[new TLabel("UF", '#ff0000', '14px', 'B', '100%'),$uf],[new TLabel("Cidade", '#ff0000', '14px', 'B', '100%'),$cidade_id,$button_],[new TLabel("CEP", null, '14px', null, '100%'),$cep]);
