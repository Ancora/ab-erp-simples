...
class PessoaFormWindow extends TWindow
{
    ...
    public function __construct( $param )
    {
        ...
        $grupo = new TDBCheckGroup('grupo', 'ancora907_erpsimples', 'Grupo', 'id', '{descricao}','id asc'  );
        $nome = new TEntry('nome');
        $oculto = new THidden('oculto');
        $cpf_cnpj = new TEntry('cpf_cnpj');
        $uf = new TDBCombo('uf', 'ancora907_erpsimples', 'Cidade', 'uf_id', '{uf->sigla}','descricao asc'  );
        $cidade_id = new TDBCombo('cidade_id', 'ancora907_erpsimples', 'Cidade', 'id', '{descricao}','descricao asc'  );
        ...
        $row3 = $this->form->addFields([new TLabel("UF", '#ff0000', '14px', 'B', '100%'),$uf],[new TLabel("Cidade", '#ff0000', '14px', 'B', '100%'),$cidade_id]);
