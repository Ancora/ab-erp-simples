...
class UfList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $id = new TEntry('id');
        $descricao = new TDBUniqueSearch('descricao', 'ancora907_erpsimples', 'Uf', 'id', 'descricao','descricao asc'  );
        $sigla = new TDBUniqueSearch('sigla', 'ancora907_erpsimples', 'Uf', 'id', 'sigla','descricao asc'  );
