...
class CidadeList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $id = new TEntry('id');
        $descricao = new TDBUniqueSearch('descricao', 'ancora907_erpsimples', 'Cidade', 'id', 'descricao','descricao asc'  );
        $uf_id = new TDBUniqueSearch('uf_id', 'ancora907_erpsimples', 'Uf', 'id', 'sigla','descricao asc'  );
