...
class ProdutoReport extends TPage
{
    ...
    public function __construct()
    {
        ...
        $id = new TEntry('id');
        $tipo_produto_id = new TDBCombo('tipo_produto_id', 'ancora907_erpsimples', 'TipoProduto', 'id', '{descricao}','descricao asc'  );
        $pessoa_id = new TDBUniqueSearch('pessoa_id', 'ancora907_erpsimples', 'Pessoa', 'id', 'nome','nome asc'  );
        $ativo = new TCombo('ativo');
        $descricao = new TEntry('descricao');
        $medida_id = new TDBCombo('medida_id', 'ancora907_erpsimples', 'Medida', 'id', '{descricao}','descricao asc'  );
